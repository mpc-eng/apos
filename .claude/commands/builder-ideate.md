...
4. **What's the regional catalyst?** Regulation, workforce shortage, structural market force that creates urgency NOW. Not "would be nice" — "must act by [date]."
...
**Regional catalyst:** [Specific regulatory/structural force with date]
...
For each idea scoring 4+, write the **showcase moment**. The demo must show a **SYSTEM working**, not a feature displayed.
...
## Lessons Learned (Embedded from Ideation Cycle)
